...
- **Inertia Factor (Pink)**: Market resistance to change (0.65,0.75,0.85)
- **Mean Price (Purple)**: Average price sensitivity (0.2,0.3)
- **Price SD (Grey)**: Price sensitivity variation (0.01,0.05)
- **Smoothing (Teal)**: Price smoothing factor (0.01,0.05)
""")
